...
Function ConfigureApplications
{
   ...
   $serviceAadApplication = New-MgApplication -DisplayName "ms-identity-react-c3s1-api" `
                                                       -Web `
                                                       @{ `
   ...
   # create the application 
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-react-c3s1-spa" `
                                                   -Spa `
                                                   @{ `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ms-identity-react-c3s1-spa")
