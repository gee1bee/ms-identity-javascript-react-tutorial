...
Function ConfigureApplications
{
   ...
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-react-c1s1" `
                                                   -Spa `
                                                   @{ `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ms-identity-react-c1s1")
    ...
    $dictionary = @{ "Enter_the_Application_Id_Here" = $spaAadApplication.AppId;"Enter_the_Tenant_Info_Here" = $tenantId;"Enter_the_Redirect_Uri_Here" = $spaAadApplication.Spa.RedirectUris;"Enter_the_Post_Redirect_Uri_Here" = $spaAadApplication.Spa.RedirectUris };
