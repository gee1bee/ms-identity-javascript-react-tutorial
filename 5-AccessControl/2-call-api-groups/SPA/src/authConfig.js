...
export const msalConfig = {
    auth: {
        ...
        redirectUri: "Enter_the_Application_Id_Here", // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
        postLogoutRedirectUri: "Enter_the_Client_Secret_Here", // Indicates the page to navigate after logout.
